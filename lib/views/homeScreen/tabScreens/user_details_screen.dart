    ...
    await FirebaseFirestore.instance.collection("users").doc(widget.userID).get().then((snapshot) {
      if (snapshot.exists) {
        ...
        setState(() {
          ...
          weightController.text = snapshot["weight"];
              ...
              children: [
                ElevatedButton(
                  style: ButtonStyle(
                      ...
                      side: MaterialStateProperty.all(BorderSide(color: Colors.black, width: 3)),
                      backgroundColor: MaterialStateProperty.all(Colors.amberAccent),
                      elevation: MaterialStateProperty.all(20),
                      fixedSize: MaterialStateProperty.all(Size.fromWidth(MediaQuery.of(context).size.width - 36))),
                  onPressed: () {
                    Get.defaultDialog(
                      title: "Personal info",
                      onConfirm: () {
                        profileController.fillPersonalInfoDetails(
                          ...
                          child: Column(
                            children: [
                              ...
                              CustomTextFormField(
                                ...
                                hintText: "A line describing you",
                        ...
                        child: SingleChildScrollView(
                          ...
                          child: Column(
                            children: [
                              ...
                              CustomTextFormField(
                                  controller: bodyTypeController, hintText: "Enter your Body Type", icon: Icon(Icons.type_specimen_sharp)),
                            ],
                          ),
                        ),
                      ),
                ...
                ElevatedButton(
                  ...
                  onPressed: () {
                    Get.defaultDialog(
                      ...
                      titleStyle: TextStyle(fontSize: 25),
                      onConfirm: () {
                        profileController.fillLifeStyleDetails(
                            drinkController.text,
                            smokeController.text,
                            maritalStatusController.text,
                            haveChildrenController.text,
                            int.parse(noOfChildrenController.text),
                          ...
                          child: Column(
                            children: [
                              CustomTextFormField(
                                ...
                                hintText: "About your drinking habit",
                              ...
                              CustomTextFormField(
                                  controller: maritalStatusController, hintText: "Marital Status", icon: Icon(Icons.person_2_outlined)),
                              SizedBox(
                                height: 10,
                              ),
                              CustomTextFormField(
                                  controller: haveChildrenController, hintText: "Do you have children?", icon: Icon(Icons.person_3_rounded)),
                              SizedBox(
                                height: 10,
                              ),
                              CustomTextFormField(
                                  controller: noOfChildrenController, hintText: "Numbber of children", icon: Icon(Icons.person_4_outlined)),
                              SizedBox(
                                height: 10,
                              ),
                              CustomTextFormField(
                              ...
                              CustomTextFormField(
                                  controller: willingToRelocateController,
                                  hintText: "Are you willing to relocate to another place?",
                                  icon: Icon(Icons.person_2)),
                              SizedBox(
                                height: 10,
                              ),
                              CustomTextFormField(
                                  controller: relationshipYouAreLookingForController,
                                  hintText: "What relationship are you looking for in a partner?",
                ...
                ElevatedButton(
                  ...
                  onPressed: () {
                    Get.defaultDialog(
                      title: " Background-Cultural Values ",
                      backgroundColor: Colors.amber,
                      titlePadding: EdgeInsets.all(10),
                      titleStyle: TextStyle(fontSize: 25),
                      onConfirm: () {
                        profileController.fillBackgroundDetails(
                        ...
                        child: SingleChildScrollView(
                          ...
                          child: Column(
                            children: [
                              ...
                              CustomTextFormField(
                                  controller: religionController, hintText: "Religion", icon: Icon(CupertinoIcons.checkmark_seal_fill)),
                              SizedBox(
                                height: 10,
                              ),
                              CustomTextFormField(
